    ...
    <div className="hero">
      <div className="hSection left">
        ...
        <motion.div
          ...
          className="awards"
        >
          <motion.h2 variants={awardVariants}>Computer Science student</motion.h2>
          <motion.p variants={awardVariants}>
            I'm persuing my Bachelors in Computer Science and Engineering from Gyan Ganga Institute of Technology Science, Jabalpur.
          </motion.p>
        </motion.div>
        {/* SCROLL SVG */}
        <motion.a
